            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full" key={index}>
              <a className="block relative h-60 rounded overflow-hidden">
                ...
                layoutId={product.id.toString()}
                  alt="ecommerce"
                  className="object-cover object-center w-full h-full block transition-all transform hover:scale-105"
                  src={product.image}
                />
              </a>
              <div className="mt-4">
                ...
                <Link
                  ...
                  className="mt-2 text-pink-600 hover:scale-x-105 transition-all transform"
                >
                  View{">>"}
                </Link>
              </div>
