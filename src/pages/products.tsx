    ...
    return (
        <>
            <div className="mt-10 lg:mt-32 mx-auto container">
                <h1 className="lg:text-5xl text-2xl text-center f-m-w text-indigo-700 font-bold">Featured Listing</h1>
                <div className="py-8 h-full lg:flex items-center justify-between xl:px-0 px-4">
                    <div className="h-full lg:w-1/3 lg:mr-8 lg:mb-0 mb-4">
                        <div className="w-full h-96 relative">
                            <img src="https://cdn.tuk.dev/assets/components/111220/pd-9/1.png" className="absolute w-full h-full inset-0 object-center object-cover z-10" />
                            <div className="left-0 px-3 flex items-cente mb-3 justify-between bottom-0 w-full absolute z-20 pt-4">
                                <h4 className="f-m-m px-6 py-3 rounded-md bg-white">$3000</h4>
                        ...
                        <div className="mt-12">
                            <h1 className="f-m-m text-2xl font-semibold leading-7">Sydney, Australia</h1>
                    ...
                    <div className="h-full lg:w-1/3 lg:mr-8 lg:mb-0 mb-4">
                        <div className="w-full h-96 relative">
                            <img src="https://cdn.tuk.dev/assets/components/111220/pd-9/2.png" className="absolute w-full h-full inset-0 object-center object-cover z-10" />
                        ...
                        <div className="mt-12">
                            <h1 className="f-m-m text-2xl font-semibold leading-7">New York, USA</h1>
                            <p className="text-base f-m-m leading-loose mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. It has survived not only five centuries. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            <div className="mt-6">
                                <a>
                                    <p className="text-indigo-700 underline cursor-pointer text-base font-semibold">View Details</p>
                    ...
                    <div className="h-full lg:w-1/3 lg:mr-8 lg:mb-0 mb-4">
                        <div className="w-full h-96 relative">
                            <img src="https://cdn.tuk.dev/assets/components/111220/pd-9/3.png" className="absolute w-full h-full inset-0 object-center object-cover z-10" />
                            <div className="left-0 px-3 flex items-center mb-3 justify-between bottom-0 w-full absolute z-20 pt-4">
                                <h4 className="f-m-m px-6 py-3 rounded-md bg-white">$3000</h4>
                                <div className="py-3 px-1 bg-black flex items-center rounded-md bg-opacity-75">
                                    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center justify-center lg:mt-16 lg:pb-48 w-full">
                    <button className="hover:bg-gray-100 border border-indigo-700 border md:text-2xl text-lg rounded f-m-m font-semibold text-indigo-700 focus:outline-none md:px-12 px-6 md:py-6 py-3 xl:leading-4">Browse All</button>
                </div>
            </div>
        </>
    );
